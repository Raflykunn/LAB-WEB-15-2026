...
# Repositori Tugas Pemrograman Berorientasi Objek (PBO) 2026
...
2. **Clone** repositori hasil **fork** anda
   ...
   git clone https://github.com/YOUR_USERNAME/LAB-WEB-15-2026.git
...
8. Setelah asistensi dan tugas anda disetujui, **push** seluruh _file_ jawaban yang telah anda buat
   ...
   Jika sebelumnya belum pernah menghubungkan Git di komputer dengan akun GitHub kamu, maka kamu akan diminta untuk mengisi username dan password untuk
   melakukan push ke repo GitHub kamu.
   ```sh

   # username = username kamu
   # password = persocal access token kamu
